  ...
  return (
    <section>
      <div className="grid sm:grid-cols-1 md:grid-cols-2">
        <Button
          onClick={() => router.back()}
          className="absolute bg-primary text-white p-3 rounded-xl top-10 left-10 h-12"
        >
          <IoReturnUpBack className="text-2xl" />
        </Button>

        <div className="flex justify-center items-center h-screen">
          <div className="space-y-4 shadow-[0_0_100px_0px_rgba(240,66,66,0.1)] p-8 rounded-2xl bg-white dark:bg-zinc-950 w-[460px]">
            <div className="flex justify-center">
              <Image src={logo} alt="Logo Image" width={120} />
            </div>
            <h3 className="text-primary text-center mb-6">Shohoje Rokto</h3>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (phoneNumber.length >= 11) {
                        e.target.value = "";
                        toast.warning("Phone number cannot be grater than 11.");
                        return;
                      }
        ...
        <div className="flex justify-center items-center h-screen bg-light dark:bg-transparent sm:hidden md:block"></div>
      </div>
    </section>
  );
};
